...
public class CreateEnemies : MonoBehaviour {
	...
	void Start () {
		for (int i = 0; i < instanceCount; ++i) {
			...
			Vector3 position = new Vector3(Random.Range(spawn.position[0]-250, spawn.position[0]+250), Random.Range(spawn.position[1]-20, spawn.position[1]+20), Random.Range(spawn.position[2]-200, spawn.position[2]+200));
