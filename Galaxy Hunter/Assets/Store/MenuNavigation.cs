...
public class MenuNavigation : MonoBehaviour {
	...
	public RectTransform InventoryHeaderParent;
	...
	public void selectStoreIcon() {
		...
		inventoryIconBG.color = new Color32(255, 255, 255,50);
	...
	public void selectInventoryIcon() {
		...
		if ( ( (Color32) inventoryIconBG.color).a == 0)  {
			return;
		}

		storeIconBG.color = new Color32(255, 255, 255,50);
		inventoryIconBG.color = new Color32(255, 255, 255,0);
		helpIconBG.color = new Color32(255, 255, 255,50);
		purchaseIconBG.color = new Color32(255, 255, 255,50);

		Header.SetParent (InventoryHeaderParent);
		...
		if (StoreActions.INSTANCE.PurchaseCompleteNotification.enabled) {
			StoreActions.INSTANCE.changePurchaseStatus(StoreActions.PurchaseStatus.NO_ITEM_SELECTED);
		}
